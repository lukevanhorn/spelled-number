...
module.exports = {
    ...
    /* function toWords 
     * @param {String|Number} [numbers] Whole Number to convert into word string
     * @return {String}  Returns formatted word string or null if error
     */
    toWords: function (numbers) {
        ...
        //do not convert numbers larger than 14 digits
